...
This package also includes the data set called `cranes`. This is a simple data set that contains information about the number of cranes at Aransas Natlional Wildlife Refuge in Austwell, Texas by year from 1938 to 2016.
...
multiply(100,50) # Multiplies the two numbers and gives the output
divide(100,50) # Divides the first number by the second number
